...
mod tests {
    ...
    use disk_speed_test::{BenchmarkResults, TestResult, BenchmarkError, ProgressCallback};
    ...
    fn create_edge_case_test_results() -> BenchmarkResults {
        BenchmarkResults {
            ...
            sequential_read: TestResult::new(15000.0, 25000.0, 20000.0, Duration::from_secs(3600), 50000),
            random_write: TestResult::new(0.0, 0.0, 0.0, Duration::from_secs(0), 0),
            random_read: TestResult::new(f64::INFINITY, f64::NEG_INFINITY, f64::NAN, Duration::from_secs(1), 1),
    ...
    fn test_format_duration_comprehensive() {
        ...
        assert_eq!(callback.format_duration(Duration::from_secs(3661)), "61m 1s");
        
        // Test fractional seconds with minutes
        assert_eq!(callback.format_duration(Duration::from_millis(60500)), "1m 0s");
        assert_eq!(callback.format_duration(Duration::from_millis(61500)), "1m 1s");
    }
    ...
    fn test_display_error_comprehensive() {
        let errors = vec![
            BenchmarkError::PlatformError(PlatformError::UnsupportedPlatform("Test OS".to_string())),
            BenchmarkError::IoError(io::Error::new(io::ErrorKind::PermissionDenied, "Access denied")),
            ...
            BenchmarkError::InsufficientSpace { required: 1024*1024*1024, available: 512*1024*1024 },
