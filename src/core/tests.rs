...
mod tests {
    ...
    fn test_sequential_read_basic_functionality() {
        ...
        // Verify the test completed successfully
        assert!(result.is_ok(), "Sequential read test should complete successfully");
    ...
    fn test_random_write_basic_functionality() {
        ...
        // Verify the test completed successfully
        assert!(result.is_ok(), "Random write test should complete successfully");
    ...
    fn test_random_read_basic_functionality() {
        ...
        // Verify the test completed successfully
        assert!(result.is_ok(), "Random read test should complete successfully");
    ...
    fn test_random_read_seek_verification() {
        ...
        assert!(result.is_ok(), "Random read with seek operations should work");
        
        let test_result = result.unwrap();
        
        // Should have read some data
        assert!(test_result.sample_count > 0, "Should have collected samples");
        assert!(test_result.avg_speed_mbps >= 0.0, "Should have measured some speed");
    ...
    fn test_random_read_large_block_count() {
        ...
        assert!(result.is_ok(), "Random read with many possible positions should work");
    ...
    fn test_memory_copy_basic_functionality() {
        ...
        // Verify the test completed successfully
        assert!(result.is_ok(), "Memory copy test should complete successfully");
    ...
    fn test_memory_copy_small_memory_size() {
        ...
        assert!(result.is_ok(), "Should handle block size larger than memory size");
    ...
    fn test_memory_copy_data_integrity() {
        ...
        assert!(test_result.sample_count > 0, "Should have performed copy operations");
        assert!(test_result.avg_speed_mbps > 0.0, "Should have measured positive throughput");
    }
